  ...
  return (
    <div className="flex min-h-screen w-full bg-background">
      ...
      <main className={`flex-1 flex flex-col min-h-screen transition-all duration-300 ${
        ...
        {user && (
          <header className="header fixed top-0 left-0 lg:left-[70px] right-0 z-40 flex h-16 items-center justify-between border-b bg-background px-4 lg:px-6">
        ...
        <div className="content-area flex-1 overflow-auto pt-16">
          <Routes>
